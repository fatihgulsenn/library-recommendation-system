...
export const mockBooks: Book[] = [
  ...
  },
  {
    ...
    author: 'Andrew Mango',
    genre: 'History',
    description: 'A comprehensive biography of Mustafa Kemal Ataturk and the founding of modern Turkey.',
    coverImage: '/book-covers/ataturk-andrew-mango.jpg',
    rating: 4.6,
    publishedYear: 2000,
    isbn: '9780713993225',
  },
  {
    id: '44',
    title: 'Ataturk: The Rebirth of a Nation',
    author: 'Lord Kinross',
    genre: 'History',
    description: 'A classic narrative of Ataturk and the transformation of the Ottoman Empire.',
    coverImage: '/book-covers/ataturk-rebirth.jpg',
    rating: 4.5,
    publishedYear: 1964,
    isbn: '9780688023829',
  },
  {
    ...
    genre: 'History',
    description: 'Ataturk\'s historic address detailing the Turkish War of Independence.',
